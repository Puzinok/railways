...
class ControllersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create controller" do
    assert_difference('Controller.count') do
      post controllers_url, params: { controller: { name: @controller.name, railways_station: @controller.railways_station } }
    end
  ...
  test "should update controller" do
    patch controller_url(@controller), params: { controller: { name: @controller.name, railways_station: @controller.railways_station } }
